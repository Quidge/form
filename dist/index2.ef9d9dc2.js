...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"scripts/index2.js":[function(require,module,exports) {
...
$("#submitFinal").hide();
$("#measurementsForm").before("<div class='row my-2'><div class='col'><ul class='nav nav-fill bg-secondary text-white' id='steps'></ul></div></div>");

steps.each(function (i) {
	// var name = $(this).find("legend").html();
	var name = $(this).attr('name');
	$("#steps").append("<li class='nav-item p-2' id='stepDesc" + i + "'><span class='text-capitalize'>Step " + (i + 1) + ": " + name + "</span></li>");
	// $(this).wrap("<div id='step" + i + "'></div>");
	$(this).attr('id', 'step' + i);
	$('.section_content', this).append('<div class="row py-2"><div class="col d-flex justify-content-between" id="step' + i + 'commands"></div></div>');
	createDevButton(i);
	if (i == 0) {
		...
		$("#step" + i + "commands").append("<button type='submit' id='submitFormButton' class='btn btn-success'>Submit</button>");
	} else {
		$("#step" + i).hide();
		createPrevButton(i);
		createNextButton(i);
...
function selectStep(i) {
	$("#steps li").removeClass("active bg-primary");
	$("#stepDesc" + i).addClass("active bg-primary");
}
...
function updateSummaryPage() {
	$(".summary.clothing-category-row").each(function () {
		...
		$('div.measurement-info', summaryCategoryDiv).each(function () {
			...
			// overwrite the placeholder text for measurement type
			// $('span.measurement-type', $(this)).text(measurementType);
			// overwrite the placeholder value for measurement start val
			$('span.measurement-value[data-measurement_value_type="start"]', $(this)).text(msmt_val - tolerance_val + '"');
			// overwrite the placeholder value for measurement end val
...
},{}]},{},["../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","scripts/index2.js"], null)
//# sourceMappingURL=/index2.ef9d9dc2.map